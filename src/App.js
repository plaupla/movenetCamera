...
// //5. Load movenet DONE
// //6. upload video - using react player npm DONE
// //6. Detect function DONE
// //7. Draw function to UI DONE
// //8. Detect video target DONE
// //9. extract video into each frames Done separately
// //10. run the extracted video to movenet Done separately
// //11. store the result by creating server, RESTapi
// //11. Calculate pose estimation on video 
// //12. Compare web stream and video
// //13. show result of comparison in UI
// //14. Use detection 


//Redoing from mdshohelrana github.
//modif on mobil since I don't need to detect if its mobile device or not
